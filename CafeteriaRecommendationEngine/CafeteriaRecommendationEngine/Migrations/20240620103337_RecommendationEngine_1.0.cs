    ...
    public partial class RecommendationEngine_10 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotedItem", x => x.VoteId);
                    table.ForeignKey(
                        name: "FK_VotedItem_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VotedItem_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VotedItem_ItemId",
                table: "VotedItem",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_VotedItem_UserId",
                table: "VotedItem",
                column: "UserId");
        }
